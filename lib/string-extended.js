...
String.prototype.toCurrency = function() {
	// The regex pattern matches all digits in the string that have
	// a grouping of three digits after them and then captures and
	// replaces them with the captured group and a comma besice it
	// Returns a string in currency format e.g. 1500 --> 1,500.00
...
String.prototype.isDigit = function() {
	...
	// Returns a boolean
	return /^\d{1}$/.test(this); //Matches a single digit as the only content in a string
};
